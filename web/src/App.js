...
import AdapterPage from "./components/adapter/AdapterPage";
import EnforcerPage from "./components/enforcer/EnforcerPage";
      ...
      <div>
        <Layout className="layout">
          <Header style={{ padding: "0", marginBottom: "3px" }}>
            ...
            >
              <Text style={{ marginRight: "20px", fontSize: "x-large" }}>
                Dashboard
              </Text>
