...
class AdapterPage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      classes: props,
  ...
  getAdapter(adapterId) {
    Backend.getAdapter(adapterId).then(res => {
      this.setState({
        adapter: res
      });
    });
  ...
  updateAdapter = () => {
    ...
    Promise.all([
      Backend.updateAdapter(this.state.adapter),
      Backend.setAdapterAllPolicies(
        this.state.adapter.id,
        this.state.pPolicies.concat(this.state.gPolicies)
      )
    ])
      .then(values => {
        Setting.showMessage("success", `Save succeeded`);
    ...
    return (
      <Card
        ...
        title={
          <div>
            Edit Adapter:
            <Tag color="rgb(232,18,36)">{this.state.adapterId}</Tag>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <Button type="primary" onClick={this.updateAdapter}>
              Save Change
            </Button>
          </div>
        }
      ...
      >
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            ...
            >
              {["MySQL", "PostgreSQL", "SQLite"].map((type, index) => (
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.adapter.param1}
              onChange={e => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Input
              value={this.state.adapter.param2}
              onChange={e => {
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={22}>
            <Button
              type="primary"
              onClick={this.testAdapterConnection}
            >
              Test Connection
            </Button>
          </Col>
        ...
        <Row style={{ marginTop: "20px" }}>
          ...
          <Col span={10}>
            <PolicyTable
              ...
              onUpdateTable={this.onUpdatePolicies}
            />
          </Col>
          <Col span={2}></Col>
          <Col span={10}>
